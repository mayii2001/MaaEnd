...
- 🗡️ **选剑演武**：自动完成每日选剑演武 / 刷刻章镀层，地区发展日常多一份轻松！
...
- 🦉 **资源回收站**：自动收取武陵和四号谷地猫头鹰回收站物资，路过别忘了！
- 🧭 **批量探测器**：批量使用罗盘 / 探物器，指定地区连点探宝，开荒挖宝更省事！
- 🎈 **浮空回收**：自动放置气球并保持平衡，浮空回收小游戏也能挂机过！
- 🚡 **滑索坐标导入**：从官方地图导入当前账号滑索坐标，供自动寻路使用（导入一次长期有效）！
- 🔄 **切换编队**：大世界一键切换指定编队，开荒换队更顺手！
- 🎁 **赠送干员礼物**：自动前往联络台，给干员送礼并顺手领取回礼，好感度慢慢拉满！
- 🔫 **武库升级 & 生产制造**：武器升级、装备制造、简易制作、批量简易制作自动化，解放双手，轻松提升战力和产能！💪
- 💰 **自动倒卖**：自动囤货、购买稳定物资、售卖弹性需求物资多线配合，盯利润、控调度券，倒卖党狂喜！💸
...
- 🗑️ **批量删除好友**：按最后上线时间清理长期未登录好友，自动跳过带备注的，好友列表清爽不少！
- 💬 **Baker 嘴替**：自动清掉会话消息，聊天红点和提示一并收拾干净！
- 📁 **情报档案库**：扫描档案库已收录条目并记录，还可一键导入 Open Endfieldmap 查看缺失档案！
- 🧮 **抽数计算**：读取寻访资源并扫描仓库寻访券，估算当前池 / 下版本池子抽数，抽卡党贴心助手！
- 🔑 **自动切换账号**：自动登出并切换到指定账号（国服手机号 / 国际服邮箱匹配），多号日常更方便！
- 📅 **日常自动化**：日常奖励（任务/通行证/邮件/暂存区/活动）、模拟空间奖励、百科红点、简制手册领取……一键清空！✅
- 💊 **自动吃药**：应急理智加强剂一键开吃，省一步是一步~💊
- 💻 **多端适配**：支持 PC (Win32)、安卓 (ADB)、Linux、macOS 等多端控制器，无论你在哪个平台，我们都能陪你摸鱼~ 🐟
