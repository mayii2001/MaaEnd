...
const (
	selectBestOperatorRecognitionName      = "OutpostTradingSelectBestOperator"
	currentBestOperatorRecognitionName     = "OutpostTradingCurrentBestOperator"
	currentOperatorUncachedRecognitionName = "OutpostTradingCurrentOperatorUncached"
	operatorCacheReadyRecognitionName      = "OutpostTradingOperatorCacheReady"
	operatorListBottomRecognitionName      = "OutpostTradingOperatorListBottom"
	operatorScanOutcomeRecognitionName     = "OutpostTradingOperatorScanOutcome"
)
...
func (r *CurrentOperatorUncachedRecognition) Run(
	...
	if err := invalidateOperatorSnapshotForUID(resolveOutpostTradingCachePathFunc(), currentOutpostTradingCacheUID()); err != nil {
